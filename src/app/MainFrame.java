...
public class MainFrame extends JFrame {	
	...
	*/
	...
	public void initPopUpMenus(){
		...
		i = 3;
		String [] jmena3 = {"Expedice a \"pøenos do archivu\"", "Licí plán – základní", "Licí plán – plánovací"};
		...
		String [] jmena4 = {
				...
				"V\u00FDpis polo\u017Eek s odhadovanou hmotnosti", "V\u00FDpis zakázek s term\u00EDnem expedice v daném týdnu",
				 ...
				 "Inventura rozpracovan\u00E9 v\u00FDroby", "V\u00FDpis skladu ke dne\u0161n\u00EDmu dni", "Výpis zmetkù za období", "Výpis viníkù v kg/kè za období"};
		...
		i = 6;
		String [] jmena6 = {"Pøidat viníky", "Pøidat druhy vad"};
