...
-- Schema pomdb
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `pomdb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `pomdb` ;

-- -----------------------------------------------------
-- Table `pomdb`.`seznam_modelu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pomdb`.`seznam_modelu` (
  `Id_modelu` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `Jmeno_modelu` VARCHAR(30) NOT NULL,
  `Cislo_modelu` VARCHAR(30) NOT NULL,
  `Material` VARCHAR(25) NOT NULL,
  `Material_vlastni` VARCHAR(10) NULL,
  `Hmotnost` DECIMAL(10,2) UNSIGNED NOT NULL,
  `IsOdhadHmot` TINYINT(1) NOT NULL DEFAULT '1',
  `Formovna` CHAR(1) NULL,
  `Norma_slevac` DECIMAL(9,1) UNSIGNED NULL,
  `Poznamka_model` VARCHAR(50) NULL,
  PRIMARY KEY (`Id_modelu`),
  INDEX `cislo_modelu_index` (`Cislo_modelu` ASC))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `pomdb`.`zakaznici`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pomdb`.`zakaznici` (
  `Id_zakaznika` SMALLINT(5) UNSIGNED NOT NULL AUTO_INCREMENT,
  `Jmeno_zakaznika` VARCHAR(30) NOT NULL,
  PRIMARY KEY (`Id_zakaznika`),
  UNIQUE INDEX `Jmeno_zakaznika_UNIQUE` (`Jmeno_zakaznika` ASC))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_general_ci;
...
-- -----------------------------------------------------
-- Table `pomdb`.`seznam_zakazek`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pomdb`.`seznam_zakazek` (
  ...
  `Paganyrka` VARCHAR(5) NULL DEFAULT NULL,
  `Cena` DECIMAL(13,3) UNSIGNED NOT NULL,
  `IsCZK` TINYINT(1) NOT NULL,
  `IsZaKus` TINYINT(1) NOT NULL,
  `KurzEUnaCZK` DECIMAL(8,4) UNSIGNED NULL,
  `Poznamka` VARCHAR(45) NULL DEFAULT NULL,
  `Uzavreno` TINYINT(1) NOT NULL DEFAULT 0,
  `Presna_cena_za_kus` DECIMAL(17,6) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`Id_zakazky`),
  INDEX `fk_seznam_zakazek_zakaznici1_idx` (`Id_zakaznika` ASC),
  INDEX `fk_seznam_zakazek_seznam_modelu1_idx` (`Id_modelu` ASC),
  CONSTRAINT `fk_seznam_zakazek_seznam_modelu1`
    FOREIGN KEY (`Id_modelu`)
    REFERENCES `pomdb`.`seznam_modelu` (`Id_modelu`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_seznam_zakazek_zakaznici1`
    FOREIGN KEY (`Id_zakaznika`)
    REFERENCES `pomdb`.`zakaznici` (`Id_zakaznika`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- Table `pomdb`.`fyzkusy`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pomdb`.`fyzkusy` (
  ...
  `Datum_liti` DATE NULL DEFAULT NULL,
  `Cislo_tavby` VARCHAR(10) NULL DEFAULT NULL,
  `Odlito` TINYINT(1) NOT NULL DEFAULT '0',
  `Vycisteno` TINYINT(1) NOT NULL DEFAULT '0',
  `Zmetek` TINYINT(1) NOT NULL DEFAULT '0',
  `Datum_odliti` DATE NULL DEFAULT NULL,
  `Expedovano` TINYINT(1) NOT NULL DEFAULT '0',
  `Cislo_faktury` VARCHAR(19) NULL,
  `Datum_vycisteni` DATE NULL DEFAULT NULL,
  `Datum_expedice` DATE NULL,
  `Datum_zadani_zmetku` DATE NULL,
  `Teplota_liti` VARCHAR(45) NULL,
  PRIMARY KEY (`Id_kusu`),
  INDEX `fk_fyzkusy_seznam_zakazek_idx` (`Id_zakazky` ASC),
  INDEX `Id_modelu` (`Id_modelu_odlito` ASC),
  CONSTRAINT `fk_fyzkusy_seznam_zakazek`
    FOREIGN KEY (`Id_zakazky`)
    REFERENCES `pomdb`.`seznam_zakazek` (`Id_zakazky`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_fyzkusy_seznam_modelu1`
    FOREIGN KEY (`Id_modelu_odlito`)
    REFERENCES `pomdb`.`seznam_modelu` (`Id_modelu`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- Table `pomdb`.`vady`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pomdb`.`vady` (
  `idvady` SMALLINT(5) UNSIGNED NOT NULL AUTO_INCREMENT,
  `vada` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`idvady`),
  UNIQUE INDEX `vada_UNIQUE` (`vada` ASC))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `pomdb`.`zmetky_vady`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pomdb`.`zmetky_vady` (
  ...
  INDEX `fk_zmetky_vady_fyzkusy1_idx` (`Id_kusu` ASC),
  INDEX `fk_zmetky_vady_vinici1_idx` (`Id_vinika` ASC),
  UNIQUE INDEX `Id_kusu_UNIQUE` (`Id_kusu` ASC),
  INDEX `fk_zmetky_vady_vady1_idx` (`Id_vady` ASC),
  CONSTRAINT `fk_zmetky_vady_fyzkusy1`
    FOREIGN KEY (`Id_kusu`)
    REFERENCES `pomdb`.`fyzkusy` (`Id_kusu`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_zmetky_vady_vinici1`
    FOREIGN KEY (`Id_vinika`)
    REFERENCES `pomdb`.`vinici` (`Id_vinika`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_zmetky_vady_vady1`
    FOREIGN KEY (`Id_vady`)
    REFERENCES `pomdb`.`vady` (`idvady`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `pomdb`.`dilci_terminy`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pomdb`.`dilci_terminy` (
  `Id_zakazky` INT(10) UNSIGNED NOT NULL,
  ...
  INDEX `fk_dilci_terminy_seznam_zakazek1` (`Id_zakazky` ASC),
  CONSTRAINT `fk_dilci_terminy_seznam_zakazek1`
    FOREIGN KEY (`Id_zakazky`)
    REFERENCES `pomdb`.`seznam_zakazek` (`Id_zakazky`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- function getNormaSlevaceFyzKusu
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure kontrolaPresneCenyZaKusCursor
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure planovaniRozvrhVycisteno
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure prepocitatPresnouCenuZaKus
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- function returnPresnouCenuZaKus
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure vyberVlastniMaterialy
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure vypisDenniOdlitychKusu
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure vypisDleTerminuExpediceCisloTydne
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure vypisExpedovanychKusuOdDo
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure vypisOdlituVKgKcOdDo
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure vypisOdlitychKusuOdDo
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure vypisPolozekSOdhadHmot
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure vypisRozpracovaneVyroby
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure vypisStavNeuzavrenychZakazek
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure vypisStavNeuzavrenychZakazek_short
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure vypisVycistenychKusuOdDo
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure zadejDatumVycistenehoKusu
-- -----------------------------------------------------
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `zadejOdlitek`(idKusu int(10) unsigned, isOdlito tinyint(1), datumOdliti date, isVycisteno tinyint(1), datumVycisteni date,
 isExpedovano tinyint(1), datumExpedice date, isZmetek tinyint(1), datumZadaniZmetku date, cisloTavby varchar(10), cisloFaktury varchar(19))
BEGIN
declare idModelu int(10) unsigned;
...
-- -----------------------------------------------------
-- procedure zadejPlanovanyDatumLiti
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure zadej_cislo_faktury_cislo_tavby_prohlizeci
-- -----------------------------------------------------
...
DELIMITER ;
GRANT EXECUTE ON ROUTINE `pomdb`.* TO 'havlicek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`kapacitniPropocet` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`liciPlanPlanovaci` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`liciPlanZakl` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`plan_expedice` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`planovaniRozvrh` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`planovaniRozvrhVycisteno` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberDilciTerminy` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberFyzKusy` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberModely` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberVady` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberViniky` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberZakazky2` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberZakazniky` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberZmetky` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisDenniOdlitychKusu` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisDleTerminuExpediceCisloTydne` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisExpedovanychKusuOdDo` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisKusuNaSkladu` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisMzdySlevacu` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisOdlituVKgKcOdDo` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisOdlitychKusuOdDo` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisPolozekSOdhadHmot` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisRozpracovaneVyroby` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisStavNeuzavrenychZakazek` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisStavNeuzavrenychZakazek_short` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisVinikyVKgKc` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisVycistenychKusuOdDo` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisZmetky` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisZpozdeneVyroby` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`zalohaDatabaze` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberVlastniMaterialy` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`verze` TO 'chmiel'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`kapacitniPropocet` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`liciPlanPlanovaci` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`liciPlanZakl` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`plan_expedice` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`planovaniRozvrh` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`planovaniRozvrhVycisteno` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberDilciTerminy` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberFyzKusy` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberModely` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberVady` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberViniky` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberZakazky2` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberZakazniky` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberZmetky` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisDenniOdlitychKusu` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisDleTerminuExpediceCisloTydne` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisExpedovanychKusuOdDo` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisKusuNaSkladu` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisMzdySlevacu` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisOdlituVKgKcOdDo` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisOdlitychKusuOdDo` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisPolozekSOdhadHmot` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisRozpracovaneVyroby` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisStavNeuzavrenychZakazek` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisStavNeuzavrenychZakazek_short` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisVinikyVKgKc` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisVycistenychKusuOdDo` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisZmetky` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisZpozdeneVyroby` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`zalohaDatabaze` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberVlastniMaterialy` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`verze` TO 'mracek'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`kapacitniPropocet` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`liciPlanPlanovaci` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`liciPlanZakl` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`plan_expedice` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`planovaniRozvrh` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`planovaniRozvrhVycisteno` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberDilciTerminy` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberFyzKusy` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberModely` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberVady` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberViniky` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberZakazky2` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberZakazniky` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberZmetky` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisDenniOdlitychKusu` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisDleTerminuExpediceCisloTydne` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisExpedovanychKusuOdDo` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisKusuNaSkladu` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisMzdySlevacu` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisOdlituVKgKcOdDo` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisOdlitychKusuOdDo` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisPolozekSOdhadHmot` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisRozpracovaneVyroby` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisStavNeuzavrenychZakazek` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisStavNeuzavrenychZakazek_short` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisVinikyVKgKc` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisVycistenychKusuOdDo` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisZmetky` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisZpozdeneVyroby` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`zalohaDatabaze` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberVlastniMaterialy` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`verze` TO 'hlad'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`kapacitniPropocet` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`liciPlanPlanovaci` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`liciPlanZakl` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`plan_expedice` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`planovaniRozvrh` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`planovaniRozvrhVycisteno` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberDilciTerminy` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberFyzKusy` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberModely` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberVady` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberViniky` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberZakazky2` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberZakazniky` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberZmetky` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisDenniOdlitychKusu` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisDleTerminuExpediceCisloTydne` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisExpedovanychKusuOdDo` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisKusuNaSkladu` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisMzdySlevacu` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisOdlituVKgKcOdDo` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisOdlitychKusuOdDo` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisPolozekSOdhadHmot` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisRozpracovaneVyroby` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisStavNeuzavrenychZakazek` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisStavNeuzavrenychZakazek_short` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisVinikyVKgKc` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisVycistenychKusuOdDo` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisZmetky` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisZpozdeneVyroby` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`zalohaDatabaze` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberVlastniMaterialy` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`verze` TO 'prejzkova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`kapacitniPropocet` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`liciPlanPlanovaci` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`liciPlanZakl` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`plan_expedice` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`planovaniRozvrh` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`planovaniRozvrhVycisteno` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberDilciTerminy` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberFyzKusy` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberModely` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberVady` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberViniky` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberZakazky2` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberZakazniky` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberZmetky` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisDenniOdlitychKusu` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisDleTerminuExpediceCisloTydne` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisExpedovanychKusuOdDo` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisKusuNaSkladu` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisMzdySlevacu` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisOdlituVKgKcOdDo` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisOdlitychKusuOdDo` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisPolozekSOdhadHmot` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisRozpracovaneVyroby` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisStavNeuzavrenychZakazek` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisStavNeuzavrenychZakazek_short` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisVinikyVKgKc` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisVycistenychKusuOdDo` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisZmetky` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vypisZpozdeneVyroby` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`zalohaDatabaze` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`vyberVlastniMaterialy` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`verze` TO 'kontrola'@'10.190.33.%';
GRANT EXECUTE ON ROUTINE `pomdb`.* TO 'chmielova'@'10.190.33.%';
GRANT EXECUTE ON ROUTINE `pomdb`.* TO 'jobova'@'10.190.33.%';
GRANT EXECUTE ON procedure `pomdb`.`kapacitniPropocet` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`liciPlanPlanovaci` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`liciPlanZakl` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`plan_expedice` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`planovaniRozvrh` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`planovaniRozvrhVycisteno` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vyberDilciTerminy` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vyberFyzKusy` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vyberModely` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vyberVady` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vyberViniky` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vyberZakazky2` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vyberZakazniky` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vyberZmetky` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vypisDenniOdlitychKusu` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vypisDleTerminuExpediceCisloTydne` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vypisExpedovanychKusuOdDo` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vypisKusuNaSkladu` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vypisMzdySlevacu` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vypisOdlituVKgKcOdDo` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vypisOdlitychKusuOdDo` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vypisPolozekSOdhadHmot` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vypisRozpracovaneVyroby` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vypisStavNeuzavrenychZakazek` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vypisStavNeuzavrenychZakazek_short` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vypisVinikyVKgKc` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vypisVycistenychKusuOdDo` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vypisZmetky` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vypisZpozdeneVyroby` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`zalohaDatabaze` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`vyberVlastniMaterialy` TO 'chmiel';
GRANT EXECUTE ON procedure `pomdb`.`verze` TO 'chmiel';
